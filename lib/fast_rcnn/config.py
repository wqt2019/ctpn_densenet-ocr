...
__C.TRAIN.RPN_POSITIVE_OVERLAP = 0.8  #0.7
# IOU < thresh: negative example
__C.TRAIN.RPN_NEGATIVE_OVERLAP = 0.2  #0.3
...
__C.TRAIN.RPN_PRE_NMS_TOP_N = 15000   #12000
# Number of top scoring boxes to keep after applying NMS to RPN proposals
__C.TRAIN.RPN_POST_NMS_TOP_N = 3000   #2000
...
## Number of top scoring boxes to keep after applying NMS to RPN proposals
__C.TEST.RPN_POST_NMS_TOP_N = 3000  #1000
