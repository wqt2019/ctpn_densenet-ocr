...
def gen(data_file, image_path, batchsize=128, maxlabellength=10, imagesize=(32, 280)):
    ...
    while 1:
        ...
        for i, j in enumerate(shufimagefile):
            # file=os.path.join(image_path, j)
...
if __name__ == '__main__':
    ...
    modelPath = './models/pretrain_model/weights-densenet-05-0.27.h5'
    if os.path.exists(modelPath):
        print("Loading model weights...")
        # basemodel = multi_gpu_model(basemodel, 4)
        basemodel.load_weights(modelPath)
        print('done!')

    path= './train'
    train_loader = gen(path+'/default/train.txt', path+'/default', batchsize=batch_size, maxlabellength=maxlabellength, imagesize=(img_h, img_w))
    test_loader = gen(path+'/default/train.txt', path+'/default', batchsize=batch_size, maxlabellength=maxlabellength, imagesize=(img_h, img_w))
